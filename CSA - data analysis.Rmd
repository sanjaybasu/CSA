...
colSums(qalys_10)/popl*10000
sum(colSums(qalys_10)/popl*10000)
colSums(qalys_life)/popl*10000
sum(colSums(qalys_life)/popl*10000)

# QALYS lost under Rx 1
colSums(rx1_qalys_10)/popl*10000
sum(colSums(rx1_qalys_10)/popl*10000)
colSums(rx1_qalys_life)/popl*10000
sum(colSums(rx1_qalys_life)/popl*10000)

# QALYS lost under Rx 2
colSums(rx2_qalys_10)/popl*10000
sum(colSums(rx2_qalys_10)/popl*10000)
colSums(rx2_qalys_life)/popl*10000
sum(colSums(rx2_qalys_life)/popl*10000)


# ICER of Rx 1 healthcare
(sum((sum(rx1_costs_10)+rx1_intcosts_10)/popl*10000)-sum(sum(costs_10)/popl*10000))/
  (sum(sum(rx1_qalys_10)/popl*10000)-sum(sum(qalys_10)/popl*10000))
(sum((sum(rx1_costs_life)+rx1_intcosts_life)/popl*10000)-sum(sum(costs_life)/popl*10000))/
  (sum(sum(rx1_qalys_life)/popl*10000)-sum(sum(qalys_life)/popl*10000))

# ICER of Rx 2 healthcare
(sum((sum(rx2_costs_10)+rx2_intcosts_10)/popl*10000)-sum(sum(costs_10)/popl*10000))/
  (sum(sum(rx2_qalys_10)/popl*10000)-sum(sum(qalys_10)/popl*10000))
(sum((sum(rx2_costs_life)+rx2_intcosts_life)/popl*10000)-sum(sum(costs_life)/popl*10000))/
  (sum(sum(rx2_qalys_life)/popl*10000)-sum(sum(qalys_life)/popl*10000))
...
((sum(sum(rx1_costs_10+rx1_prod_10)+rx1_intcosts_10-rx1_econben_10)/popl*10000)-sum(sum(costs_10+prod_10)/popl*10000))/(sum(sum(rx1_qalys_10)/popl*10000)-sum(sum(qalys_10)/popl*10000))
((sum(sum(rx1_costs_life+rx1_prod_life)+rx1_intcosts_life-rx1_econben_life)/popl*10000)-sum(sum(costs_life+prod_life)/popl*10000))/(sum(sum(rx1_qalys_life)/popl*10000)-sum(sum(qalys_life)/popl*10000))

# ICER of Rx 2 societal
((sum(sum(rx2_costs_10+rx2_prod_10)+rx2_intcosts_10-rx2_econben_10)/popl*10000)-sum(sum(costs_10+prod_10)/popl*10000))/(sum(sum(rx2_qalys_10)/popl*10000)-sum(sum(qalys_10)/popl*10000))
((sum(sum(rx2_costs_life+rx2_prod_life)+rx2_intcosts_life-rx2_econben_life)/popl*10000)-sum(sum(costs_life+prod_life)/popl*10000))/(sum(sum(rx2_qalys_life)/popl*10000)-sum(sum(qalys_life)/popl*10000))
