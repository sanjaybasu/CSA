...
set.seed(11)
rx1_dminter_10 = rbinom(iters,1,1-exp(-rx1_dminc_rate*10/2))
set.seed(12)
rx1_dminter_life = rbinom(iters,1,1-exp(-rx1_dminc_rate*lifeexp/2))
set.seed(13)
...
set.seed(11)
rx2_dminter_10 = rbinom(iters,1,1-exp(-rx2_dminc_rate*10/2))
set.seed(12)
rx2_dminter_life = rbinom(iters,1,1-exp(-rx2_dminc_rate*lifeexp/2))
set.seed(13)
