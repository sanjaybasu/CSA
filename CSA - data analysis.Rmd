...
(sum((sum(rx1_costs_10)+rx1_intcosts_10)/iters*10000)-sum(sum(costs_10)/iters*10000))/
  (sum(sum(rx1_qalys_10)/iters*10000)-sum(sum(qalys_10)/iters*10000))
(sum((sum(rx1_costs_life)+rx1_intcosts_life)/iters*10000)-sum(sum(costs_life)/iters*10000))/
  (sum(sum(rx1_qalys_life)/iters*10000)-sum(sum(qalys_life)/iters*10000))

# ICER of Rx 2 healthcare
(sum((sum(rx2_costs_10)+rx2_intcosts_10)/iters*10000)-sum(sum(costs_10)/iters*10000))/
  (sum(sum(rx2_qalys_10)/iters*10000)-sum(sum(qalys_10)/iters*10000))
(sum((sum(rx2_costs_life)+rx2_intcosts_life)/iters*10000)-sum(sum(costs_life)/iters*10000))/
  (sum(sum(rx2_qalys_life)/iters*10000)-sum(sum(qalys_life)/iters*10000))
...
((sum(sum(rx1_costs_10+rx1_prod_10)+rx1_intcosts_10-rx1_econben_10)/iters*10000)-sum(sum(costs_10+prod_10)/iters*10000))/(sum(sum(rx1_qalys_10)/iters*10000)-sum(sum(qalys_10)/iters*10000))
((sum(sum(rx1_costs_life+rx1_prod_life)+rx1_intcosts_life-rx1_econben_life)/iters*10000)-sum(sum(costs_life+prod_life)/iters*10000))/(sum(sum(rx1_qalys_life)/iters*10000)-sum(sum(qalys_life)/iters*10000))

# ICER of Rx 2 societal
((sum(sum(rx2_costs_10+rx2_prod_10)+rx2_intcosts_10-rx2_econben_10)/iters*10000)-sum(sum(costs_10+prod_10)/iters*10000))/(sum(sum(rx2_qalys_10)/iters*10000)-sum(sum(qalys_10)/iters*10000))
((sum(sum(rx2_costs_life+rx2_prod_life)+rx2_intcosts_life-rx2_econben_life)/iters*10000)-sum(sum(costs_life+prod_life)/iters*10000))/(sum(sum(rx2_qalys_life)/iters*10000)-sum(sum(qalys_life)/iters*10000))
