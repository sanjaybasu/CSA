...
# ICER of Rx 1
(sum(colSums(rx1_costs_10+rx1_intcosts_10+rx1_prod_10)/iters*10000)-sum(colSums(costs_10+prod_10)/iters*10000))/
  (sum(colSums(rx1_qalys_10)/iters*10000)-sum(colSums(qalys_10)/iters*10000))
(sum(colSums(rx1_costs_life+rx1_intcosts_life+rx1_prod_life)/iters*10000)-sum(colSums(costs_life+prod_life)/iters*10000))/
  (sum(colSums(rx1_qalys_life)/iters*10000)-sum(colSums(qalys_life)/iters*10000))

# ICER of Rx 2
(sum(colSums(rx2_costs_10+rx2_intcosts_10+rx2_prod_10)/iters*10000)-sum(colSums(costs_10+prod_10)/iters*10000))/
  (sum(colSums(rx2_qalys_10)/iters*10000)-sum(colSums(qalys_10)/iters*10000))
(sum(colSums(rx2_costs_life+rx2_intcosts_life+rx2_prod_life)/iters*10000)-sum(colSums(costs_life+prod_life)/iters*10000))/
  (sum(colSums(rx2_qalys_life)/iters*10000)-sum(colSums(qalys_life)/iters*10000))
