...
sum((rx1_econben_10)/iters*10000)
sum((rx1_econben_life)/iters*10000)

# econ gains under Rx 2
sum((rx2_econben_10)/iters*10000)
sum((rx2_econben_life)/iters*10000)
...
## sensitivity analysis to see what overhead rate represents the 'break-even' between cash and CSA (i.e. how cheap does the CSA have to run to offset the extra overhead)
## alternatively how much bigger an effect size would it need over cash, taking additional overhead as fixed).
