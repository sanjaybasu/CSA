...
c_ascvd_10 = c_ascvd*10/2*ascvd_events_10*(mort_events_10==0)+
  c_ascvd*10/2*ascvd_events_10*(mort_events_10==1)
c_ascvd_life = c_ascvd*lifeexp/2*ascvd_events_life*(mort_events_life==0)+
  c_ascvd*lifeexp/2*ascvd_events_life*(mort_events_life==1)
c_dminc_10 = c_dminc*10/2*dminc_events_10*(mort_events_10==0)+
  c_dminc*10/2*dminc_events_10*(mort_events_10==1)
c_dminc_life = c_dminc*lifeexp/2*dminc_events_life*(mort_events_life==0)+
  c_dminc*lifeexp/2*dminc_events_life*(mort_events_life==1)
c_esrd_10 = c_esrd*10/2*esrd_events_10*(mort_events_10==0)+
  c_esrd*10/2*esrd_events_10*(mort_events_10==1)
c_esrd_life = c_esrd*lifeexp/2*esrd_events_life*(mort_events_life==0)+
  c_esrd*lifeexp/2*esrd_events_life*(mort_events_life==1)
c_retin_10 = c_retin*10/2*retin_events_10*(mort_events_10==0)+
  c_retin*10/2*retin_events_10*(mort_events_10==1)
c_retin_life = c_retin*lifeexp/2*retin_events_life*(mort_events_life==0)+
  c_retin*lifeexp/2*retin_events_life*(mort_events_life==1)
c_neuro_10 = c_neuro*10/2*neuro_events_10*(mort_events_10==0)+
  c_neuro*10/2*neuro_events_10*(mort_events_10==1)
c_neuro_life = c_neuro*lifeexp/2*neuro_events_life*(mort_events_life==0)+
  c_neuro*lifeexp/2*neuro_events_life*(mort_events_life==1)
