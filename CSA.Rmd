...
``` {r costs}
# total annual heatlhcare cost estimates from Optum Clinformatics
...
# healthcare dollars spent at baseline
...
# healthcare dollars spent under rx 1
...
# healthcare dollars spent under rx 2
...
# ICER of Rx 1
(sum(colSums(rx1_costs_10)/iters*10000)-sum(colSums(costs_10)/iters*10000))/
  (sum(colSums(rx1_qalys_10)/iters*10000)-sum(colSums(qalys_10)/iters*10000))
(sum(colSums(rx1_costs_life)/iters*10000)-sum(colSums(costs_life)/iters*10000))/
  (sum(colSums(rx1_qalys_life)/iters*10000)-sum(colSums(qalys_life)/iters*10000))

# ICER of Rx 2
(sum(colSums(rx2_costs_10)/iters*10000)-sum(colSums(costs_10)/iters*10000))/
  (sum(colSums(rx2_qalys_10)/iters*10000)-sum(colSums(qalys_10)/iters*10000))
(sum(colSums(rx2_costs_life)/iters*10000)-sum(colSums(costs_life)/iters*10000))/
